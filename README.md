This is a simple **weather forecast web application** that fetches real-time weather data from a backend API. The app displays the **current weather** and a **5-day forecast** for a given city.  
